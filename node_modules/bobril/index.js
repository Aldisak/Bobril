...
exports.setBeforeInit = exports.init = exports.getRoots = exports.updateRoot = exports.removeRoot = exports.addRoot = exports.invalidate = exports.setInvalidate = exports.ignoreShouldChange = exports.deferSyncUpdate = exports.syncUpdate = exports.setAfterFrame = exports.setReallyBeforeFrame = exports.setBeforeFrame = exports.setBeforeRender = exports.RenderPhase = exports.emitEvent = exports.addEvent = exports.now = exports.updateChildren = exports.callEffects = exports.callPostCallbacks = exports.getLastDomNode = exports.getDomNode = exports.updateNode = exports.deref = exports.vdomPath = exports.isDisposable = exports.addDisposable = exports.createNode = exports.setMeasureConfiguration = exports.setCurrentCtx = exports.getCurrentCtx = exports.unregisterFocusRoot = exports.registerFocusRoot = exports.ieVersion = exports.setSetValue = exports.swallowPromise = exports.flatten = exports.assign = exports.assertNever = exports.isObject = exports.isFunction = exports.isBoolean = exports.isString = exports.isNumber = exports.setIsArrayVdom = exports.isArray = exports.BobrilCtx = exports.createMediaQuery = void 0;
exports.routes = exports.encodeUrlPath = exports.decodeUrl = exports.encodeUrl = exports.RouteTransitionType = exports.getDnds = exports.anyActiveDnd = exports.DndEnabledOps = exports.DndOp = exports.convertPointFromClientToNode = exports.nodePagePos = exports.getWindowScroll = exports.isScrollable = exports.removeOnScroll = exports.addOnScroll = exports.focus = exports.focused = exports.ignoreClick = exports.firstPointerDownId = exports.pointersDownCount = exports.nodeOnPoint = exports.preventClickingSpree = exports.revalidateMouseIn = exports.releaseMouseOwner = exports.registerMouseOwner = exports.isMouseOwnerEvent = exports.isMouseOwner = exports.BobrilPointerType = exports.select = exports.asap = exports.getMedia = exports.accDeviceBreaks = exports.BobrilDeviceCategory = exports.invalidated = exports.frame = exports.lastFrameDuration = exports.uptime = exports.setStyleShim = exports.cloneNode = exports.preventDefault = exports.postEnhance = exports.preEnhance = exports.allocateMethodId = exports.runMethod = exports.tryRunMethod = exports.getCurrentCtxWithEvents = exports.runMethodFrom = exports.broadcast = exports.captureBroadcast = exports.bubble = void 0;
exports.propi = exports.prop = exports.createDerivedComponent = exports.createComponent = exports.createOverridingComponent = exports.createVirtualComponent = exports.styledDiv = exports.extendCfg = exports.withRef = exports.withKey = exports.svgRect = exports.svgCircle = exports.svgPie = exports.setAsset = exports.asset = exports.injectCss = exports.spriteWithColor = exports.spritebc = exports.spriteb = exports.setSpritePaths = exports.getSpritePaths = exports.setBundlePngPath = exports.sprite = exports.setImagesWithCredentials = exports.invalidateStyles = exports.selectorStyleDef = exports.styleDefEx = exports.namedStyleDef = exports.namedStyleDefEx = exports.mediaQueryDef = exports.keyframesDef = exports.styleDef = exports.style = exports.getActiveParams = exports.getActiveRoutes = exports.getRoutes = exports.anchor = exports.Anchor = exports.runTransition = exports.transitionRunCount = exports.createBackTransition = exports.createRedirectReplace = exports.createRedirectPush = exports.link = exports.Link = exports.urlOfRoute = exports.isActive = exports.routeNotFound = exports.routeDefault = exports.route = void 0;
exports.useCaptureEvents = exports.useEvents = exports.useLayoutEffect = exports.useEffect = exports.useCallback = exports.useMemo = exports.bind = exports.useStore = exports.useRef = exports.useProvideContext = exports.useContext = exports.context = exports.createContext = exports.useReducer = exports.useState = exports._allocHook = exports._getHooks = exports.component = exports.PureComponent = exports.Component = exports.EventResult = exports.Portal = exports.Fragment = exports.createElement = exports.shallowEqual = exports.emitChange = exports.getValue = exports.debounceProp = exports.propim = exports.propa = void 0;
...
var measureFullComponentDuration = false;
var measureComponentMethods = false;
    ...
    if (component) {
        ...
        if (component.init) {
            if (DEBUG && measureComponentMethods)
                window.performance.mark(component.id + " init-start");
        ...
        if (component.render) {
            hookId = 0;
            if (DEBUG && measureComponentMethods)
                window.performance.mark(component.id + " render-start");
    ...
    if (tag === undefined) {
        ...
        if (component) {
            if (component.postRender) {
                if (DEBUG && measureComponentMethods)
                    window.performance.mark(component.id + " postRender-start");
...
function vdomPath(n) {
    ...
    var rootNodes = rootIds.map(function (i) { return roots[i].n; });
        ...
        if (component.id !== c.component.id) {
            ...
            if (component.shouldChange)
                if (!ignoringShouldChange && !locallyInvalidated) {
                    ...
                    var shouldChange = component.shouldChange(ctx, n, c);
                    if (DEBUG && measureComponentMethods)
                        window.performance.measure(component.id + " [shouldChange]", component.id + " shouldChange-start");
                    if (!shouldChange) {
    ...
    if (bigChange ||
        ...
        if (tag === "@") {
            ...
            if (createBefore != null)
                createBefore = createBefore.nextSibling;
            tag = undefined;
        }
        if (tag === undefined) {
...
function callPostCallbacks() {
    ...
    for (var i = 0; i < count; i++) {
        ...
        currentCtx = n.ctx;
        if (DEBUG && measureComponentMethods)
            window.performance.mark(n.component.id + " post-start");
...
function callEffects() {
    ...
    for (var i = 0; i < count; i++) {
        ...
        currentCtx = n.ctx;
        if (DEBUG && measureComponentMethods)
            window.performance.mark(n.component.id + " effect-start");
        var hooks = currentCtx.$hooks;
        var len = hooks.length;
        for (var i_7 = 0; i_7 < len; i_7++) {
            var hook = hooks[i_7];
            var fn = hook.useEffect;
            if (fn !== undefined) {
...
function recursiveFlattenVdomChildren(res, children) {
    ...
    if (isArrayVdom(children)) {
        for (var i_8 = 0; i_8 < children.length; i_8++) {
            recursiveFlattenVdomChildren(res, children[i_8]);
        }
    }
    else {
...
function flattenVdomChildren(res, children) {
    ...
    if (DEBUG) {
        var set = new Set();
        for (var i_9 = 0; i_9 < res.length; i_9++) {
            var key = res[i_9].key;
            if (key == undefined)
                continue;
            if (set.has(key)) {
...
var invalidate = function (ctx, deepness) {
    if (ctx != null) {
...
function overrideComponents(originalComponent, overridingComponent) {
    ...
    for (var i_10 in overridingComponent) {
        if (!(i_10 in emptyObject)) {
            var m = overridingComponent[i_10];
            var origM = originalComponent[i_10];
            if (i_10 === "id") {
                res[i_10] = (origM != null ? origM : "") + "/" + m;
            }
            else {
                res[i_10] = m;
            }
...
var pointersDownCount = function () { return Object.keys(pointersDown).length; };
exports.pointersDownCount = pointersDownCount;
var firstPointerDownId = function () { return firstPointerDown; };
exports.firstPointerDownId = firstPointerDownId;
var ignoreClick = function (x, y) {
    var delay = ieVersion() ? MaxBustDelayForIE : MaxBustDelay;
...
var dropEffectsAllowedTable = ["none", "link", "copy", "move"];
var DndEnabledOps;
...
function handleDrop(ev, _target, _node) {
    ...
    if (!dnd.local) {
        ...
        var dt = ev.dataTransfer;
        for (var i_11 = 0; i_11 < dataKeys.length; i_11++) {
            var k = dataKeys[i_11];
            var d;
            if (k === "Files") {
...
function anyActiveDnd() {
    for (var i_12 = 0; i_12 < dnds.length; i_12++) {
        var dnd = dnds[i_12];
        if (dnd.beforeDrag)
            continue;
        return dnd;
...
var getDnds = function () { return dnds; };
...
function getSetterOfNodesArray(idx) {
    while (idx >= setterOfNodesArray.length) {
        setterOfNodesArray.push((function (a, ii) { return function (n) {
            if (n) {
                var i = ii;
                a[i] = n;
                while (i-- > 0) {
...
function Anchor(_a) {
    var children = _a.children, name = _a.name, params = _a.params, onAnchor = _a.onAnchor;
...
function buildCssRule(parent, name) {
    ...
    if (parent) {
        if (exports.isArray(parent)) {
            for (var i_13 = 0; i_13 < parent.length; i_13++) {
                if (i_13 > 0) {
                    result += ",";
                }
                result += "." + buildCssSubRule(parent[i_13]) + "." + name;
            }
        }
        else {
...
function flattenStyle(cur, curPseudo, style, stylePseudo) {
    if (isString(style)) {
        ...
        for (var i_14 = 0; i_14 < style.length; i_14++) {
            flattenStyle(cur, curPseudo, style[i_14], undefined);
        }
    }
...
function beforeFrame() {
    ...
    if (hasBundledSprites && lastDppx != getMedia().dppx) {
        ...
        var newSpriteDppx = 1;
        if (lastDppx > 1) {
            for (var i_15 = 0; i_15 < bundlePath2.length; i_15++) {
                if (i_15 == bundlePath2.length - 1 || bundlePath2[i_15][1] >= lastDppx) {
                    newSpriteUrl = bundlePath2[i_15][0];
                    newSpriteDppx = bundlePath2[i_15][1];
                }
                else
                    break;
            }
    ...
    if (rebuildStyles) {
        if (hasBundledSprites) {
            ...
            if (imageSprite != null) {
                for (var i_16 = 0; i_16 < bundledDynamicSprites.length; i_16++) {
                    var dynSprite = bundledDynamicSprites[i_16];
        ...
        for (var i_17 = 0; i_17 < dynamicSprites.length; i_17++) {
            var dynSprite = dynamicSprites[i_17];
        ...
        for (var key in allStyles) {
            ...
            if (cssStyle.length > 0)
                styleStr += (name_1 == undefined ? parent_1 : buildCssRule(parent_1, name_1)) + " {" + cssStyle + "}\n";
            for (var key2 in flattenPseudo) {
                var item = flattenPseudo[key2];
                shimStyle(item);
                styleStr +=
                    (name_1 == undefined ? parent_1 + ":" + key2 : buildCssRule(parent_1, name_1 + ":" + key2)) +
                        " {" +
        ...
        for (var key in allMediaQueries) {
            ...
            styleStr += "@media " + key + "{";
            for (var _i = 0, mediaQuery_1 = mediaQuery; _i < mediaQuery_1.length; _i++) {
                var definition = mediaQuery_1[_i];
...
function namedStyleDefEx(name, parent, style, pseudo) {
    var res = styleDefEx(parent, style, pseudo, name);
    if (res != name)
        throw new Error("named style " + name + " is not unique");
    return res;
}
exports.namedStyleDefEx = namedStyleDefEx;
function namedStyleDef(name, style, pseudo) {
...
var colorLessSpriteMap = new Map();
...
function spriteWithColor(colorLessSprite, color) {
    var original = colorLessSpriteMap.get(colorLessSprite);
    if (original == undefined)
        throw new Error(colorLessSprite + " is not colorless sprite");
    if ("url" in original) {
...
exports.asset = window["bobrilBAsset"] ||
    function (path) {
        return path;
    };
...
function shallowEqual(a, b) {
    ...
    for (var i_18 = 0; i_18 < kA.length; i_18++) {
        if (!hOP.call(b, kA[i_18]) || !is(a[kA[i_18]], b[kA[i_18]])) {
            return false;
        }
    }
    return true;
...
function createElement(name, props) {
    ...
    if (argumentsCount === 0) {
        ...
        for (var i_19 = 0; i_19 < argumentsCount; i_19++) {
            children[i_19] = arguments[i_19 + 2];
        }
    }
    if (isString(name)) {
...
function Portal(data) {
    var _a;
    return { tag: "@", data: (_a = data.element) !== null && _a !== void 0 ? _a : document.body, children: data.children, key: data.key, ref: data.ref };
}
...
function useReducer(reducer, initializerArg, initializer) {
    ...
    var hook = hooks[myHookId];
    if (hook === undefined) {
        var initValue = isFunction(initializer) ? initializer(initializerArg) : initializerArg;
        hook = [
            initValue,
            function (action) {
                var currentValue = hook[0];
        ...
        if (deps != undefined) {
            ...
            if (lastDeps == undefined) {
                ...
                if (depsLen != lastDeps.length)
                    ...
                    for (var i_23 = 0; i_23 < depsLen; i_23++) {
                        if (!is(deps[i_23], lastDeps[i_23])) {
                            changed = true;
                            break;
                        }
                    }
...
var CommonEffectHook = /** @class */ (function (_super) {
    __extends(CommonEffectHook, _super);
    function CommonEffectHook() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.shouldRun = false;
        return _this;
    }
    CommonEffectHook.prototype.update = function (callback, deps) {
        this.callback = callback;
        if (this.detectChange(deps)) {
            this.doRun();
        }
    };
    CommonEffectHook.prototype.doRun = function () {
        this.shouldRun = true;
    };
    CommonEffectHook.prototype.run = function () {
        var c = this.callback;
        if (c != undefined) {
            this.dispose();
            this.lastDisposer = c();
    ...
    CommonEffectHook.prototype.dispose = function () {
        this.callback = undefined;
        if (isFunction(this.lastDisposer))
            this.lastDisposer();
        this.lastDisposer = undefined;
    };
    return CommonEffectHook;
}(DepsChangeDetector));
var EffectHook = /** @class */ (function (_super) {
    ...
    EffectHook.prototype.useEffect = function () {
        if (this.shouldRun) {
