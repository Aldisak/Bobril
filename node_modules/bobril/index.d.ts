...
export declare type IBobrilShimStyleMapping = Map<string, (style: any, value: any, oldName: string) => void>;
...
export declare type ICtxClass<TData = any> = {
...
export declare type IBobrilEventsWithCtx<TCtx> = {
    [N in keyof IBobrilEvents]?: NonNullable<IBobrilEvents[N]> extends (...args: any) => any ? Parameters<NonNullable<IBobrilEvents[N]>>["length"] extends 0 ? (ctx: TCtx) => ReturnType<NonNullable<IBobrilEvents[N]>> : (ctx: TCtx, event: Parameters<NonNullable<IBobrilEvents[N]>>[0]) => ReturnType<NonNullable<IBobrilEvents[N]>> : never;
};
export interface IBobrilComponent<TData = any, TCtx extends IBobrilCtx<TData> = any> extends IBobrilEventsWithCtx<TCtx> {
...
export declare type RefType = [IBobrilCtx, string] | ((node: IBobrilCacheNode | undefined) => void) | {
...
export declare type IBobrilNode<T = any> = Exclude<IBobrilNodeCommon<T> & object, Function>;
...
export declare type IBobrilCacheNodeUnsafe<T = any> = {
    -readonly [P in keyof IBobrilCacheNode<T>]: IBobrilCacheNode<T>[P];
};
...
declare type RuleBehaviourType = "not" | "only";
declare type MediaType = "all" | "print" | "screen" | "speech";
declare type RangeRuleWithUnitToken = {
    type: "max-height" | "min-height" | "max-width" | "min-width";
    value: number;
    unit: "px" | "em";
};
declare type RangeRuleToken = {
    type: "min-color";
    value: number;
};
declare type OrientationRuleToken = {
    type: "orientation";
    value: "landscape" | "portrait";
};
declare type AspectRuleToken = {
    type: "aspect-ratio";
    height: number;
    width: number;
};
declare type BoolRuleToken = {
    type: "color";
};
export declare type MediaQueryTokens = RangeRuleWithUnitToken | RangeRuleToken | OrientationRuleToken | AspectRuleToken | BoolRuleToken;
...
declare type MediaQueryDefinition = {
    [key: string]: CSSStylesItem;
};
export declare function createMediaQuery(): RuleBuilder;
...
export declare function setIsArrayVdom(isArrayFnc: <T>(arg: T | {}) => arg is T extends readonly any[] ? (unknown extends T ? never : readonly any[]) : any[]): void;
...
export declare function assertNever(switchValue: never): never;
...
export declare function swallowPromise<T>(promise: Promise<T>): void;
...
export declare function getCurrentCtx(): IBobrilCtx<any> | undefined;
export declare function setCurrentCtx(ctx: IBobrilCtx | undefined): void;
export declare function setMeasureConfiguration(conf: {
...
export declare function isDisposable(val: any): val is IDisposable;
export declare function vdomPath(n: Node | null | undefined): (IBobrilCacheNode | null)[];
export declare function deref(n: Node | null | undefined): IBobrilCacheNode | undefined;
...
export declare function getLastDomNode(c: IBobrilCacheNode | undefined): Node | null;
export declare function callPostCallbacks(): void;
export declare function callEffects(): void;
...
export declare function init(factory: () => IBobrilChildren, element?: HTMLElement): void;
export declare function setBeforeInit(callback: (cb: () => void) => void): void;
export declare type AllEvents = IBobrilEvents | IBubblingAndBroadcastEvents | ICapturableEvents;
export declare type EventNames = keyof ICapturableEvents;
export declare type EventParam<T extends EventNames> = T extends keyof ICapturableEvents ? NonNullable<ICapturableEvents[T]> extends (p: infer P) => any ? P : any : any;
export declare function bubble<T extends EventNames>(node: IBobrilCacheNode | null | undefined, name: T, param?: Omit<EventParam<T>, "target"> | {
    target?: IBobrilCacheNode;
}): IBobrilCtx | undefined;
export declare function captureBroadcast<T extends EventNames>(name: T, param: Omit<EventParam<T>, "target"> | {
    target?: IBobrilCacheNode;
}): IBobrilCtx | undefined;
export declare function broadcast<T extends EventNames>(name: T, param: Omit<EventParam<T>, "target"> | {
    target?: IBobrilCacheNode;
}): IBobrilCtx | undefined;
...
export declare enum BobrilDeviceCategory {
    Mobile = 0,
    Tablet = 1,
    Desktop = 2,
    LargeDesktop = 3
...
export declare enum BobrilPointerType {
    Mouse = 0,
    Touch = 1,
    Pen = 2
}
...
export declare function focus(node: IBobrilCacheNode, backwards?: boolean): boolean;
...
export declare enum DndOp {
    None = 0,
    Link = 1,
    Copy = 2,
    Move = 3
}
export declare enum DndEnabledOps {
    None = 0,
    Link = 1,
    Copy = 2,
    LinkCopy = 3,
...
export declare enum RouteTransitionType {
    Push = 0,
    Replace = 1,
    Pop = 2
}
...
export declare type IRouteHandler = IBobrilComponent | ((data: IRouteHandlerData | any) => IBobrilChildren);
...
export declare function encodeUrlPath(path: string | undefined): string;
...
export declare function Link(data: {
    name: string;
    params?: Params;
    replace?: boolean;
    style?: IBobrilStyles;
...
export declare function Anchor({ children, name, params, onAnchor }: IAnchorData): IBobrilNode;
export declare function anchor(children: IBobrilChildren, name?: string, params?: Params, onAnchor?: (el: HTMLElement) => boolean): IBobrilNode;
...
export declare type IBobrilStyle = Readonly<CSSInlineStyles> | IBobrilStyleDef | 0 | boolean | undefined | null;
export declare type IBobrilStyles = IBobrilStyle | IBobrilStyleArray;
...
export declare function styleDef(style: CSSStyles, pseudo?: CSSPseudoStyles, nameHint?: string): IBobrilStyleDef;
export declare type AnimationNameFactory = ((params?: string) => string) & ((styles: CSSInlineStyles, key: string) => string);
export declare function keyframesDef(def: Keyframes, nameHint?: string): AnimationNameFactory;
/**
 * create media query
 * @example
 ...
 *
 **/
export declare function mediaQueryDef(def: string, mediaQueryDefinition: MediaQueryDefinition): void;
export declare function namedStyleDefEx(name: string, parent: IBobrilStyleDef | IBobrilStyleDef[] | undefined, style: CSSStyles, pseudo?: CSSPseudoStyles): IBobrilStyleDef;
export declare function namedStyleDef(name: string, style: CSSStyles, pseudo?: CSSPseudoStyles): IBobrilStyleDef;
export declare function styleDefEx(parent: IBobrilStyleDef | IBobrilStyleDef[] | undefined, style: CSSStyles, pseudo?: CSSPseudoStyles, nameHint?: string): IBobrilStyleDef;
export declare function selectorStyleDef(selector: string, style: CSSStyles, pseudo?: CSSPseudoStyles): void;
...
export declare function spriteWithColor(colorLessSprite: IBobrilStyleDef, color: string): IBobrilStyleDef;
export declare function injectCss(css: string): void;
export declare let asset: (path: string) => string;
export declare function setAsset(fn: (path: string) => string): void;
...
export declare function withKey(content: IBobrilChildren, key: string): IBobrilNodeWithKey;
...
export declare function styledDiv(children: IBobrilChildren, ...styles: IBobrilStyles[]): IBobrilNode;
export declare type ChildrenType<TData extends {
    [name: string]: any;
}> = "children" extends keyof TData ? TData["children"] : never;
export interface IComponentFactory<TData extends object | never> {
    (data?: TData, children?: ChildrenType<TData>): IBobrilNode<TData>;
}
export declare function createVirtualComponent<TData extends object | never, TCtx extends IBobrilCtx<TData> = any>(component: IBobrilComponent<TData, TCtx>): IComponentFactory<TData>;
export declare function createOverridingComponent<TData extends object | never, TDataOriginal = any>(original: (data?: TDataOriginal, children?: ChildrenType<TDataOriginal>) => IBobrilNode, after: IBobrilComponent): IComponentFactory<TData>;
export declare function createComponent<TData extends object | never, TCtx extends IBobrilCtx<TData> = any>(component: IBobrilComponent<TData, TCtx>): IComponentFactory<TData>;
export declare function createDerivedComponent<TData extends object | never, TDataOriginal extends object | never>(original: (data?: TDataOriginal, children?: ChildrenType<TDataOriginal>) => IBobrilNode<TDataOriginal>, after: IBobrilComponent<TData>): IComponentFactory<TData & TDataOriginal>;
...
export declare function debounceProp<T>(from: IProp<T>, delay?: number): IProp<T>;
...
export declare function createElement<T>(name: string | ((data?: T, children?: any) => IBobrilNode) | IComponentClass<T> | IComponentFunction<T>, data?: T, ...children: IBobrilChildren[]): IBobrilNode<T>;
export interface IFragmentData extends IBobrilEvents {
    children: IBobrilChildren;
    key?: string;
    ref?: RefType;
}
export declare function Fragment(data: IFragmentData): IBobrilNode;
...
export declare function Portal(data: IPortalData): IBobrilNode;
...
export declare type GenericEventResult = EventResult | boolean | void;
export declare class Component<TData = IDataWithChildren> implements IBobrilEvents {
...
export declare class PureComponent<TData = IDataWithChildren> extends Component<TData> {
    shouldChange(newData: TData, oldData: TData): boolean;
}
export interface IComponentFunction<TData extends Object = {}> extends Function {
    (this: IBobrilCtx, data: TData): IBobrilChildren;
}
export declare function component<TData extends object>(component: IComponentClass<TData> | IComponentFunction<TData>, name?: string): IComponentFactory<TData>;
export declare function _getHooks(): any[];
export declare function _allocHook(): number;
export declare function useState<T>(initValue: T | (() => T)): IProp<T> & [T, (value: T | ((value: T) => T)) => void];
...
export declare function useReducer<R extends Reducer<any, any>, I>(reducer: R, initializerArg: I & ReducerState<R>, initializer: (arg: I & ReducerState<R>) => ReducerState<R>): [ReducerState<R>, Dispatch<ReducerAction<R>>];
export declare function useReducer<R extends Reducer<any, any>, I>(reducer: R, initializerArg: I, initializer: (arg: I) => ReducerState<R>): [ReducerState<R>, Dispatch<ReducerAction<R>>];
export declare function useReducer<R extends Reducer<any, any>>(reducer: R, initialState: ReducerState<R>, initializer?: undefined): [ReducerState<R>, Dispatch<ReducerAction<R>>];
export interface IContext<T> {
    id: string;
    dv: T;
}
export declare function createContext<T = unknown>(defaultValue: T, id?: string): IContext<T>;
export declare function context<T>(key: IContext<T>): (target: object, propertyKey: string) => void;
export declare function useContext<T>(key: IContext<T>): T;
export declare function useContext<T = unknown>(key: string): T | undefined;
export declare function useProvideContext(key: string, value: any): void;
export declare function useProvideContext<T>(key: IContext<T>, value: T): void;
export declare function useRef<T = unknown>(initialValue?: T): IProp<T> & {
    current: T;
};
export declare function useStore<T>(factory: () => T): T;
declare type EffectCallback = () => void | (() => void | undefined);
declare type DependencyList = ReadonlyArray<unknown>;
export declare function bind(target: any, propertyKey?: string, descriptor?: PropertyDescriptor): any;
export declare function useMemo<T>(factory: () => T, deps: DependencyList): T;
export declare function useCallback<T>(callback: T, deps: DependencyList): T;
export declare function useEffect(callback: EffectCallback, deps?: DependencyList): void;
export declare function useLayoutEffect(callback: EffectCallback, deps?: DependencyList): void;
export declare function useEvents(events: IHookableEvents): void;
export declare function useCaptureEvents(events: ICapturableEvents): void;
...
export declare type StringHint = string & {
    zz_ignore_me?: never;
};
export declare type NumberHint = number & {
    zz_ignore_me?: never;
};
export declare type CSSValueGeneral = NumberHint | StringHint;
export declare type CSSGlobalValues = "initial" | "inherit" | /** combination of `initial` and `inherit` */ "unset" | "revert" | StringHint;
...
export declare type CSSBox = "border-box" | "padding-box" | "content-box" | CSSGlobalValues | StringHint;
export declare type CSSColor = "transparent" | "currentColor" | CSSGlobalValues | StringHint;
export declare type CSSFlexAlign = "flex-start" | "flex-end" | "center" | "baseline" | "stretch";
export declare type CSSFontSize = CSSGlobalValues | CSSValueGeneral | "xx-small" | "x-small" | "small" | "medium" | "large" | "x-large" | "xx-large" | "larger" | "smaller";
export declare type CSSLineStyle = StringHint | "none" | "hidden" | "dotted" | "dashed" | "solid" | "double" | "groove" | "ridge" | "inset" | "outset";
export declare type CSSOverflow = "visible" | "hidden" | "scroll" | "clip" | "auto";
export declare type CSSRepeatStyle = StringHint | "repeat-x" | "repeat-y" | "repeat" | "space" | "round" | "no-repeat";
export declare type CSSFontWeight = "normal" | "bold" | "bolder" | "lighter" | 100 | 200 | 300 | 400 | 500 | 600 | 700 | 800 | 900 | CSSValueGeneral | CSSGlobalValues;
export declare type CSSLazy<T> = T | StringHint | ((styles: CSSInlineStyles, key: string) => T | StringHint);
export declare type CSSLazyString = CSSLazy<string>;
export declare type CSSLazyValueGeneral = CSSLazy<CSSValueGeneral>;
/**
...
export interface CSSInlineStyles {
     ...
     */
    cursor?: CSSLazy<CSSGlobalValues | StringHint | "auto" | "default" | "none" | "context-menu" | "help" | "pointer" | "progress" | "wait" | "cell" | "crosshair" | "text" | "vertical-text" | "alias" | "copy" | "move" | "no-drop" | "not-allowed" | "e-resize" | "n-resize" | "ne-resize" | "nw-resize" | "s-resize" | "se-resize" | "sw-resize" | "w-resize" | "ew-resize" | "ns-resize" | "nesw-resize" | "nwse-resize" | "col-resize" | "row-resize" | "all-scroll" | "zoom-in" | "zoom-out" | "grab" | "grabbing">;
    /**
...
export declare type CSSStylesItem = IBobrilStyleDef | ((styles: CSSInlineStyles, pseudo: CSSPseudoStyles) => void) | Readonly<CSSInlineStyles> | boolean | null | undefined;
export declare type CSSStyles = CSSStylesItemArray | CSSStylesItem;
