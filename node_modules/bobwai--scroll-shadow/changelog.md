# 2.12.0
## Added
- optional property 'scrollShadowType' which could be used to enable horizontal scroll shadow (used in bobwai--table)
- optional property 'leftShadowOffset' to be able to move left shadow into specified place of viewport (used in bobwai--table)
- optional property 'shouldResetZIndex' to be able to reset zIndex of internal content (used in bobwai--table)
- optional property 'onHorizontalScrollbarVisibilityChanged' to be able also detect horizontal scroll changes (used in bobwai--table)
