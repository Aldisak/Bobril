...
describe('store', function () {
    ...
    describe('setState', function () {
        ...
        describe('with booting and nullableNumber cursor', function () {
            beforeEach(function () {
                s.bootstrap(tds.default());
            });
            it('read null from state', function () {
                var value = s.getState(tds.nullableNumberCursor);
                expect(value).toBeNull();
            });
            it('write value to state', function () {
                s.setState(tds.nullableNumberCursor, 10);
                expect(s.getState(tds.nullableNumberCursor)).toBe(10);
            });
            it('write null to state', function () {
                s.setState(s.rootCursor, {
                    todos: [{ done: false, name: 'First Todo' }],
                    nullableNumber: 10
                });
