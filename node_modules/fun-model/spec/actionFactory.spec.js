...
describe('actionFactory', function () {
    ...
    describe('createAction', function () {
        describe('when action threw during handling and catching have not been enabled', function () {
            ...
            beforeEach(function () {
                ...
                throwingAction = af.createParamLessAction(NestedCursorTestFixture, function () {
        ...
        describe('when renderCallback has not been set', function () {
            ...
            it('throws if key does not exist', function () {
                expect(function () {
                    var testAction = af.createParamLessAction(NestedCursorTestFixture, function () { return { state: 'new nested state' }; });
                    testAction();
        ...
        describe('when renderCallback has been set', function () {
            ...
            it('does not report current state when state has not been changed.', function () {
                ...
                af.createParamLessAction(NestedCursorTestFixture, function (state) { return state; })();
            ...
            it('reports state changed when debug has been enabled.', function () {
                ...
                givenStore(aState('nestedStateValue'));
                af.createParamLessAction(NestedCursorTestFixture, function () { return newState; })();
            ...
            it('does not call render callback when state has not been changed', function () {
                givenStore(aState('nestedStateValue'));
                var testAction = af.createParamLessAction(NestedCursorTestFixture, function (state) { return state; });
                testAction();
                expect(renderCallback).not.toHaveBeenCalled();
            });
            it('calls render callback when state has been changed', function () {
                givenStore(aState('nestedStateValue'));
                var testAction = af.createParamLessAction(NestedCursorTestFixture, function () { return { state: 'newValue' }; });
                testAction();
                expect(renderCallback).toHaveBeenCalled();
            });
            it('calls nested actions', function () {
                givenStore(aState('value'));
                var nestedAction2 = af.createParamLessAction(NestedCursorTestFixture, function (state) {
                    return { state: state.state + " -> newValueFromNestedAction2" };
                });
                var nestedAction = af.createParamLessAction(NestedCursorTestFixture, function (state) {
                    nestedAction2();
                    return { state: state.state + " -> newValueFromNestedAction" };
                });
                af.createParamLessAction(NestedCursorTestFixture, function () {
                    nestedAction();
            ...
            it('does not throw on immutability violation in no debug mode', function () {
                ...
                givenStore(aState('nestedStateValue'));
                var testAction = af.createParamLessAction(SomeCursorTestFixture, function (state) {
    ...
    describe('createActions', function () {
        describe('when renderCallback has not been set', function () {
            it('throws if key does not exist', function () {
                expect(function () {
                    var testAction = af.createParamLessActions({
